...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		private function gc():void
		{
			...
			if (_isMouseScroll)
				_maskHolder.removeEventListener(MouseEvent.MOUSE_MOVE, mouseMove);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		private function setMajorSettings():void
		{
			...
			if (_isMouseScroll)
				_maskHolder.addEventListener(MouseEvent.MOUSE_MOVE, mouseMove, false, 0, true);
		...
		protected function contentMover(e:Event = null):void
		{
			...
			if (_checkContentWH)
			{
				if (_maskContent.height != _oldContentH && _maskContent.width == _oldContentW)
				{
					...
					{
						if (this._bitmapMode == ScrollConst.STRONG)
			...
			function scrollVSetting($doAni:Boolean = true):void
			{
				...
				if ($doAni)
				{
					...
					if (_blurEffect && _aniInterval != 0)
						TweenMax.to(_maskContentHolder, _aniInterval, {blurFilter: {blurY: __vSpeed}, ease: _easeTypeFunc});
				}
			...
			function scrollHSetting($doAni:Boolean = true):void
			{
				...
				if ($doAni)
				{
					...
					if (_blurEffect && _aniInterval != 0)
						TweenMax.to(_maskContentHolder, _aniInterval, {blurFilter: {blurX: __hSpeed}, ease: _easeTypeFunc});
				}
			...
			if (!_hScroll && _vScroll) // if we have _vScroll
			{
				...
				else
				{
					...
					if (_blurEffect && _aniInterval != 0)
						TweenMax.to(_maskContentHolder, _aniInterval, {blurFilter: {blurX: 0, blurY: 0, remove: true}, onUpdate: _mask.update, ease: _easeTypeFunc});
			...
			else if (_hScroll && _vScroll) // if we have _hScroll and _vScroll
			{
				...
				else if (_oldYLoc != _yLoc && _oldXLoc != _xLoc)
				{
					...
					if (_blurEffect && _aniInterval != 0)
						TweenMax.to(_maskContentHolder, _aniInterval, {blurFilter: {blurX: __hSpeed, blurY: __vSpeed}, ease: _easeTypeFunc});
				}
				else if (_oldYLoc == _yLoc && _oldXLoc == _xLoc)
				{
					if (_blurEffect && _aniInterval != 0)
